...
- (NSNumber *)profileId {
  if (self.isAdMobMediationPresent) {
...
- (BOOL)isAdMobMediationPresent {
  return
    NSClassFromString(@"CRBannerCustomEvent") != nil &&
    NSClassFromString(@"CRInterstitialCustomEvent") != nil &&
    NSProtocolFromString(@"GADMediationAdapter") != nil;
}
