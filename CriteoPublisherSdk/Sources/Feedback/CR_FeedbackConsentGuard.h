...
#ifndef CR_FeedbackConsentGuard_H
#define CR_FeedbackConsentGuard_H
...
@interface CR_FeedbackConsentGuard : NSObject <CR_FeedbackDelegate>
...
#endif /* CR_FeedbackConsentGuard_H */
