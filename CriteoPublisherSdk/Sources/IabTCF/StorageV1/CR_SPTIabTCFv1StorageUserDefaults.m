...
- (void)registerDefaultUserDefault {
  NSDictionary *dataStorageDefaultValues = [NSDictionary
      dictionaryWithObjectsAndKeys:@"", SPT_IABConsent_ConsentStringKey, @"",
                                   SPT_IABConsent_ParsedVendorConsentsKey, @"",
                                   SPT_IABConsent_ParsedPurposeConsentsKey,
                                   [NSNumber numberWithBool:NO], SPT_IABConsent_CMPPresentKey, nil];
...
- (SubjectToGDPR)subjectToGDPR {
  NSString *subjectToGDPRAsString =
      [self.userDefaults objectForKey:SPT_IABConsent_SubjectToGDPRKey];
...
- (void)setParsedPurposeConsents:(NSString *)parsedPurposeConsents {
  [self.userDefaults setObject:parsedPurposeConsents
                        forKey:SPT_IABConsent_ParsedPurposeConsentsKey];
  [self.userDefaults synchronize];
}
