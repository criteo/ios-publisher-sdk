...
private extension CRFulllScreenContainer {
    @objc
    ...
    func circleLayer(in bounds: CGRect) -> CAShapeLayer {
    ...
    func xLayerInBounds(in bounds: CGRect) -> CAShapeLayer {
        let layer = CAShapeLayer()
        let x = UIBezierPath()
    ...
    func applySafeAreaConstraints(to closeButton: UIButton) {
    ...
    func applyConstraints(to webView: UIView, width: CGFloat, height: CGFloat) {
    ...
    func referenceViewForCloseButton(for size: CGSize) -> UIView {
