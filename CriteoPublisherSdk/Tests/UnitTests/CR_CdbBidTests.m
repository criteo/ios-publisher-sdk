...
- (void)setUp {
  ...
  self.adUnit = [[CR_CacheAdUnit alloc] initWithAdUnitId:@"adUnit1" width:300 height:250];

  NSURL *jsonURL = [[NSBundle bundleForClass:[self class]] URLForResource:@"SampleBid"
                                                            withExtension:@"json"];

  NSString *jsonText = [NSString stringWithContentsOfURL:jsonURL
  ...
  NSDictionary *responseDict = [NSJSONSerialization JSONObjectWithData:self.jsonData
                                                               options:0
                                                                 error:&e];
  if (e) {
    XCTFail(@"%@", e);
...
- (BOOL)testHashAndIsEqualForUnequalObjects:(NSDictionary *)dict key:(id)key modValue:(id)modValue {
  ...
  CR_CdbBid *bidNewTime1 =
      [[CR_CdbBid alloc] initWithDict:dict receivedAt:[self.now dateByAddingTimeInterval:50000]];
  CR_CdbBid *bidNewTime2 =
      [[CR_CdbBid alloc] initWithDict:dict receivedAt:[self.now dateByAddingTimeInterval:50000]];
...
- (void)testInitialization {
  ...
  XCTAssertEqualObjects(nativeBid.nativeAssets.products[0].description,
                        @"We're All About Comfort.");
  XCTAssertEqualObjects(nativeBid.nativeAssets.products[0].price, @"$99");
  XCTAssertEqualObjects(nativeBid.nativeAssets.products[0].clickUrl,
                        @"https://cat.sv.us.criteo.com/delivery/ckn.php?");
  XCTAssertEqualObjects(nativeBid.nativeAssets.products[0].callToAction, @"scipio");
  XCTAssertEqualObjects(nativeBid.nativeAssets.products[0].image.url,
                        @"https://pix.us.criteo.net/img/img?");
  ...
  XCTAssertEqualObjects(nativeBid.nativeAssets.products[1].description,
                        @"We're NOT About Comfort.");
  XCTAssertEqualObjects(nativeBid.nativeAssets.products[1].price, @"$9999");
  XCTAssertEqualObjects(nativeBid.nativeAssets.products[1].clickUrl,
                        @"https://cat.sv.us.criteo.com/delivery/ckn2.php?");
  XCTAssertEqualObjects(nativeBid.nativeAssets.products[1].callToAction, @"Buy this blinkin dress");
  XCTAssertEqualObjects(nativeBid.nativeAssets.products[1].image.url,
                        @"https://pix.us.criteo.net/img/img2?");
  ...
  XCTAssertEqualObjects(nativeBid.nativeAssets.advertiser.logoClickUrl,
                        @"https://cat.sv.us.criteo.com/delivery/ckn.php?");
  XCTAssertEqualObjects(nativeBid.nativeAssets.advertiser.logoImage.url,
                        @"https://pix.us.criteo.net/img/img?");
  ...
  XCTAssertEqualObjects(nativeBid.nativeAssets.privacy.optoutClickUrl,
                        @"https://privacy.us.criteo.com/adcenter?");
  XCTAssertEqualObjects(nativeBid.nativeAssets.privacy.optoutImageUrl,
  ...
  XCTAssertEqualObjects(nativeBid.nativeAssets.impressionPixels[0],
                        @"https://cat.sv.us.criteo.com/delivery/lgn.php?");
  XCTAssertEqualObjects(nativeBid.nativeAssets.impressionPixels[1],
                        @"https://cat.sv.us.criteo.com/delivery2/lgn.php?");

  XCTAssertEqualObjects(nativeBid.skAdNetworkParameters.version, @"version");
...
- (void)testUnequalObjects {
  ...
  [self testHashAndIsEqualForUnequalObjects:self.bannerJDict
                                        key:@"displayUrl"
                                   modValue:@"rfdcb54x"];
  NSMutableDictionary *modAssetsDict =
      [[NSMutableDictionary alloc] initWithDictionary:self.nativeJDict[@"native"]];
...
- (void)testCdbBidsWithData {
  ...
  CR_CdbBid *testBid_3 = [[CR_CdbBid alloc]
             initWithZoneId:@(1234567)
  ...
  CR_CdbBid *testBid_4 = [[CR_CdbBid alloc]
             initWithZoneId:@(1234567)
...
- (NSMutableDictionary *)createMutableDictionaryFromJSONFileWithNative:(BOOL)isNative {
  ...
  NSMutableDictionary *responseDict =
      [NSJSONSerialization JSONObjectWithData:self.jsonData
