...
@property(weak, nonatomic, readonly) CR_DependencyProvider *withPrefetchOnInitEnabled;
@property(weak, nonatomic, readonly) CR_DependencyProvider *withLiveBiddingDisabled;
