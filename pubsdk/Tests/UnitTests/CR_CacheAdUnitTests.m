...
- (void) testAdUnitHash {
    CR_CacheAdUnit *first = [[CR_CacheAdUnit alloc] initWithAdUnitId:@"testAdUnit" size:CGSizeMake(400, 150) adUnitType:CRAdUnitTypeBanner];
    CR_CacheAdUnit *second = [[CR_CacheAdUnit alloc] initWithAdUnitId:@"testAdUnit" size:CGSizeMake(400, 150) adUnitType:CRAdUnitTypeBanner];
...
- (void) testAdUnitHash_2 {
    ...
    CR_CacheAdUnit *first = [[CR_CacheAdUnit alloc] initWithAdUnitId:@"testAdUnit" size:sizeFirst adUnitType:CRAdUnitTypeBanner];
...
- (void) testAdUnitHashNotEqual {
    ...
    CR_CacheAdUnit *third = [[CR_CacheAdUnit alloc] initWithAdUnitId:@"testAdUnit" size:CGSizeMake(400, 150) adUnitType:CRAdUnitTypeNative];
...
- (void) testAdUnitHashNotEqual_2 {
    ...
    CR_CacheAdUnit *second = [[CR_CacheAdUnit alloc] initWithAdUnitId:@"testAdUnit" size:sizeSecond adUnitType:CRAdUnitTypeBanner];
...
- (void) testAdUnitIsNotEqualWhenAdUnitTypeNotEqual {
    ...
    CR_CacheAdUnit *first = [[CR_CacheAdUnit alloc] initWithAdUnitId:@"testAdUnit" size:size adUnitType:CRAdUnitTypeNative];
    CR_CacheAdUnit *second = [[CR_CacheAdUnit alloc] initWithAdUnitId:@"testAdUnit" size:size adUnitType:CRAdUnitTypeInterstitial];
...
- (void)testNativeAdUnitAndHashIsEqual {
    CR_CacheAdUnit *native_1 = [[CR_CacheAdUnit alloc] initWithAdUnitId:@"testAdUnit" size:CGSizeMake(400, 150) adUnitType:CRAdUnitTypeNative];
    CR_CacheAdUnit *native_2 = [[CR_CacheAdUnit alloc] initWithAdUnitId:@"testAdUnit" size:CGSizeMake(400, 150) adUnitType:CRAdUnitTypeNative];
...
- (void)testCopyWithZone {
    CR_CacheAdUnit *adUnit_1 = [[CR_CacheAdUnit alloc] initWithAdUnitId:@"testAdUnit" size:CGSizeMake(400, 150) adUnitType:CRAdUnitTypeBanner];
    CR_CacheAdUnit *adUnit_1Copy = [adUnit_1 copyWithZone:nil];
    XCTAssertTrue([adUnit_1 isEqual:adUnit_1Copy]);

    CR_CacheAdUnit *adUnit_2 = [[CR_CacheAdUnit alloc] initWithAdUnitId:@"testAdUnit" size:CGSizeMake(400, 150) adUnitType:CRAdUnitTypeInterstitial];
    ...
    CR_CacheAdUnit *adUnit_4 = [[CR_CacheAdUnit alloc] initWithAdUnitId:@"testAdUnit" size:CGSizeMake(400, 150) adUnitType:CRAdUnitTypeNative];
