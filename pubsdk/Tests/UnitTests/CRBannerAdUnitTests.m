...
- (void)testSameBannerAdUnitsHaveSameHash {
  CRBannerAdUnit *bannerAdUnit1 =
      [[CRBannerAdUnit alloc] initWithAdUnitId:@"String1" size:CGSizeMake(350.0f, 50.0f)];
  CRBannerAdUnit *bannerAdUnit2 =
      [[CRBannerAdUnit alloc] initWithAdUnitId:[@"Str" stringByAppendingString:@"ing1"]
                                          size:CGSizeMake(350.0f, 50.0f)];
...
- (void)testDifferentBannerAdUnitsHaveDifferentHash {
  ...
  CRBannerAdUnit *bannerAdUnit2 =
      [[CRBannerAdUnit alloc] initWithAdUnitId:[@"Str" stringByAppendingString:@"ing1"]
                                          size:CGSizeMake(350.0f, 200.0f)];
  XCTAssertNotEqual(bannerAdUnit1.hash, bannerAdUnit2.hash);

  CRBannerAdUnit *bannerAdUnit3 =
      [[CRBannerAdUnit alloc] initWithAdUnitId:@"String1" size:CGSizeMake(350.0f, 50.0f)];
  CRBannerAdUnit *bannerAdUnit4 =
      [[CRBannerAdUnit alloc] initWithAdUnitId:@"String1" size:CGSizeMake(350.0f, 200.0f)];
  XCTAssertNotEqual(bannerAdUnit3.hash, bannerAdUnit4.hash);

  CRBannerAdUnit *bannerAdUnit5 =
      [[CRBannerAdUnit alloc] initWithAdUnitId:@"String1" size:CGSizeMake(350.0f, 50.0f)];
  CRBannerAdUnit *bannerAdUnit6 =
      [[CRBannerAdUnit alloc] initWithAdUnitId:@"Changed" size:CGSizeMake(350.0f, 50.0f)];
