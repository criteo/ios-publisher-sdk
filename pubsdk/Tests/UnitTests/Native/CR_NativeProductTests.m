...
- (void)setUp {
  self.jdict = @{
    ...
    @"callToAction" : @"scipio",
    @"image" :
        @{@"url" : @"https://pix.us.criteo.net/img/img?", @"height" : @(400), @"width" : @(500)}
  };
  NSString *jsonText = @"{\n"
                        "\"title\": \"\\\"Stripe Pima Dress\\\" - $99\",\n"
                        "\"description\": \"We're All About Comfort.\",\n"
...
- (void)checkHashAndIsEqualForUnequalObjects:(NSDictionary *)dict
                                         key:(id)key
                                    modValue:(id)modValue {
...
- (void)testUnequalObjects {
  ...
  [self checkHashAndIsEqualForUnequalObjects:self.jdict
                                         key:@"image"
                                    modValue:@{
                                      @"url" : @"https://pix",
                                      @"height" : @(400),
