...
//  pubsdkTests
//
//  Created by Romain Lofaso on 4/23/20.
...
- (instancetype)initWithAdUnit:(CRInterstitialAdUnit *)adUnit
    ...
    if (self = [super init]) {
        _receiveAdExpectation = [[XCTestExpectation alloc] initWithDescription:
                                 @"CRInterstitialDelegate.interstitialDidReceiveAd called"];
        _failToReceiveAdExpectation = [[XCTestExpectation alloc] initWithDescription:
                                       @"CRInterstitialDelegate.didFailToReceiveAdWithError called"];
        _criteo = criteo;
        _adUnit = adUnit;
        _intertitial = [[CRInterstitial alloc] initWithAdUnit:adUnit
                                                       criteo:criteo];
...
- (void)resetExpectations {
    self.receiveAdExpectation = [[XCTestExpectation alloc] initWithDescription:
                                 @"CRInterstitialDelegate.interstitialDidReceiveAd called"];
    self.failToReceiveAdExpectation = [[XCTestExpectation alloc] initWithDescription:
                                       @"CRInterstitialDelegate.didFailToReceiveAdWithError called"];
}
