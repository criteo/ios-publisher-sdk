...
- (void)testBannerSuccess {
    ...
    CRBannerView *bannerView = [[CRBannerView alloc] initWithFrame:CGRectMake(13.0f, 17.0f, 47.0f, 57.0f) criteo:mockCriteo webView:mockWebView];

    CRAdUnit *expectedAdUnit💡 = [[CRAdUnit alloc] initWithAdUnitId:@"123" size:CGSizeMake(47.0f, 57.0f)];
...
- (void)testWithRendering {
    ...
    CRBannerView *bannerView = [[CRBannerView alloc] initWithFrame:CGRectMake(13.0f, 17.0f, 47.0f, 57.0f) criteo:mockCriteo webView:realWebView];
