...
- (IBAction)loadInterstitialClicked:(id)sender {
    self.presentInterstitialButton.enabled = NO;
    self.interstitial = [MPInterstitialAdController interstitialAdControllerForAdUnitId:@"8e011bf4cf7a42cb9db61fde30a2af58"];
...
- (void)interstitialDidFailToLoadAd:(MPInterstitialAdController *)interstitial
    ...
    NSLog(@"MPInterstitialAdControllerDelegate.interstitialDidFailToLoadAd withError: %@", error.localizedDescription);
}
